...
export default function Projects() {
  return (
    ...
    <div className="mainproject" id='project' >
       ...
       <div className="box">
       <a href="https://weather-app-with-api-blond.vercel.app/"> <div className="imgcontain">
        ...
        <div className="box">
        <a href="https://microsoft-home-demo.vercel.app/"><div className="imgcontain">
       ...
       <div className="box">
       <a href="https://project-1-pi-nine.vercel.app/">
